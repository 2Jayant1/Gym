...
function QuickNavCard({ icon: Icon, label, desc, gradient, onClick, delay = 0 }) {
  ...
  return (
    ...
    >
      <div
        className={`absolute inset-0 bg-gradient-to-br ${gradient} opacity-0 group-hover:opacity-[0.06] transition-opacity duration-500`}
      />
    ...
    <PageShell title="Trainer Portal" subtitle="Your overview and today's schedule.">
      ...
      >
        <div
          ...
          style={{
            background:
              'linear-gradient(90deg, transparent, rgba(245,158,11,0.3), transparent, rgba(16,185,129,0.3), transparent)',
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        >
          ...
          <div className="flex items-center justify-around flex-wrap gap-6">
            ...
            <ProgressRing
              progress={
                sessions.length > 0 ? Math.min((todaySessions.length / Math.max(sessions.length / 7, 1)) * 100, 100) : 0
              }
              size={110}
              strokeWidth={10}
              color="#f59e0b"
            ...
            />
            <ProgressRing
              progress={classes.length > 0 ? 100 : 0}
              size={110}
              strokeWidth={10}
              color="#10b981"
            ...
            <AnimatePresence>
              {upcoming.map((s, i) => (
                ...
                >
                  ...
                  <motion.div
                    whileHover={{ x: 4, borderColor: 'rgb(165,180,252)' }}
                  ...
                  >
                    ...
                    <div className="text-right flex flex-col items-end gap-1.5">
                      ...
                      <span
                        className={`text-xs px-2.5 py-0.5 rounded-full border font-medium ${statusColors[s.status] || statusColors.scheduled}`}
                      >
                        {s.status}
                      </span>
                    </div>
